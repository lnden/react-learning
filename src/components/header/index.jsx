  ...
  render(){
    return(
      <header className="header-container">
        ...
        {
          this.props.record&&<NavLink to="/record" exact className="header-link icon-jilu">1111</NavLink>
        }
        {
          this.props.confirm&&<NavLink to="/" exact className="header-link header-link-confim">确定222</NavLink>
        }
